...
python scripts/zydus_queries_chemformer_responses_eval.py src/chemformer/data/zydus_queries_chemformer_responses_9b2360.yaml
```

Writes:
- `src/chemformer/data/zydus_queries_chemformer_eval_9b2360.yaml` — full evaluation with `summary`, `results`, and cached PubChem data

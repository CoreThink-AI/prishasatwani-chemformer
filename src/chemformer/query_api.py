...
from .rdkut import canonical_smiles, mol_weight

DEFAULT_API_URL = "https://chemformer-retrosynthesis-knq67derjq-uc.a.run.app"
...
def expand(smiles, depth, visited=set(),
        max_depth=DEFAULT_MAX_DEPTH,
        min_ll=DEFAULT_MIN_LL,
    ...
    for pred in viable:
        ...
        reaction_node = {
            ...
            "reactants": [
                expand(r, depth + 1, visited=visited,
                    max_depth=max_depth,
                    min_ll=min_ll,
                    max_mw=max_mw,
                    n_beams=n_beams,
...
def main():
    ...
    parser.add_argument("--n-beams", type=int, default=DEFAULT_N_BEAMS)
    parser.add_argument("--max-depth", type=int, default=DEFAULT_MAX_DEPTH)
    parser.add_argument("--min-ll", type=float, default=DEFAULT_MIN_LL)


    parser.add_argument("--max-mw", type=float, default=DEFAULT_MAX_MW)
